...
function stock(symbol, shares, exchange) {
  this.symbol = symbol;
  this.shares = shares;
...
stock.prototype.calcValue = function(price) {
  total_price = this.shares * price;
  console.log("Your shares of " + this.symbol + " are worth " + total_price);
  return total_price;
}

var visa = new stock("V", 100, "NYSE");
visa.buyShares(50);
visa.sellShares(75);
