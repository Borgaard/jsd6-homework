...
function Stock(letters, numShares){
  this.symbol = letters;
  this.shares = numShares;
  this.exchange = "NYSE";
};

Stock.prototype.buyShares = function(num){
  this.shares += num;
};
Stock.prototype.sellShares = function(num){
  this.shares -= num;
};
Stock.prototype.calcValue = function(num){
  var value = this.shares * num;
  console.log(value);
  return value;
};
...
console.log("the exchange for visa is " + visa.exchange);
console.log("the exchange for apple is " + apple.exchange);
